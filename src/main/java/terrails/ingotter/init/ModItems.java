...
public class ModItems {
    ...
    public static void init() {
        if (ConfigHandler.wireHammer) {
            HAMMER = add(new ItemCraftingDurabilityBase("hammer", 128, true).setCreativeTab(Constants.TOOLS_TAB));
            WIRE_CUTTERS = add(new ItemCraftingDurabilityBase("wire_cutters", 128, true).setCreativeTab(Constants.TOOLS_TAB));
        }
    ...
    private static void initIngots() {
        COPPER_INGOT = add(new ItemBase("copper_ingot"));
        TIN_INGOT = add(new ItemBase("tin_ingot"));
        SILVER_INGOT = add(new ItemBase("silver_ingot"));
        LEAD_INGOT = add(new ItemBase("lead_ingot"));
        ALUMINUM_INGOT = add(new ItemBase("aluminum_ingot"));
        NICKEL_INGOT = add(new ItemBase("nickel_ingot"));
        PLATINUM_INGOT = add(new ItemBase("platinum_ingot"));
        STEEL_INGOT = add(new ItemBase("steel_ingot"));
        ELECTRUM_INGOT = add(new ItemBase("electrum_ingot"));
        BRONZE_INGOT = add(new ItemBase("bronze_ingot"));
        INVAR_INGOT = add(new ItemBase("invar_ingot"));
    }
    private static void initNuggets() {
        if (ConfigHandler.ingotNuggets) {
            COPPER_NUGGET = add(new ItemBase("copper_nugget"));
            TIN_NUGGET = add(new ItemBase("tin_nugget"));
            SILVER_NUGGET = add(new ItemBase("silver_nugget"));
            LEAD_NUGGET = add(new ItemBase("lead_nugget"));
            ALUMINUM_NUGGET = add(new ItemBase("aluminum_nugget"));
            NICKEL_NUGGET = add(new ItemBase("nickel_nugget"));
            PLATINUM_NUGGET = add(new ItemBase("platinum_nugget"));
            STEEL_NUGGET = add(new ItemBase("steel_nugget"));
            ELECTRUM_NUGGET = add(new ItemBase("electrum_nugget"));
            BRONZE_NUGGET = add(new ItemBase("bronze_nugget"));
            IRON_NUGGET = add(new ItemBase("iron_nugget"));
            INVAR_NUGGET = add(new ItemBase("invar_nugget"));
        }
        if (ConfigHandler.gemNuggets) {
            COAL_NUGGET = add(new ItemBase("coal_nugget") {
                @Override
                public int getItemBurnTime(ItemStack itemStack) {
                    return 200;
                }
            });
            DIAMOND_NUGGET = add(new ItemBase("diamond_nugget"));
            EMERALD_NUGGET = add(new ItemBase("emerald_nugget"));
            LAPIS_NUGGET = add(new ItemBase("lapis_nugget"));
            REDSTONE_NUGGET = add(new ItemBase("redstone_nugget"));
        }
    }
    private static void initDusts() {
        COPPER_DUST = add(new ItemBase("copper_dust"));
        TIN_DUST = add(new ItemBase("tin_dust"));
        SILVER_DUST = add(new ItemBase("silver_dust"));
        LEAD_DUST = add(new ItemBase("lead_dust"));
        ALUMINUM_DUST = add(new ItemBase("aluminum_dust"));
        NICKEL_DUST = add(new ItemBase("nickel_dust"));
        PLATINUM_DUST = add(new ItemBase("platinum_dust"));
        STEEL_DUST = add(new ItemBase("steel_dust"));
        ELECTRUM_DUST = add(new ItemBase("electrum_dust"));
        BRONZE_DUST = add(new ItemBase("bronze_dust"));
        IRON_DUST = add(new ItemBase("iron_dust"));
        GOLD_DUST = add(new ItemBase("gold_dust"));
        INVAR_DUST = add(new ItemBase("invar_dust"));
        COAL_DUST = add(new ItemBase("coal_dust") {
            @Override
            public int getItemBurnTime(ItemStack itemStack) {
                return 1800;
            }
        });
        DIAMOND_DUST = add(new ItemBase("diamond_dust"));
        EMERALD_DUST = add(new ItemBase("emerald_dust"));
        LAPIS_DUST = add(new ItemBase("lapis_dust"));
    }
    private static void initPlates() {
        COPPER_PLATE = add(new ItemBase("copper_plate"));
        TIN_PLATE = add(new ItemBase("tin_plate"));
        SILVER_PLATE = add(new ItemBase("silver_plate"));
        LEAD_PLATE = add(new ItemBase("lead_plate"));
        ALUMINUM_PLATE = add(new ItemBase("aluminum_plate"));
        NICKEL_PLATE = add(new ItemBase("nickel_plate"));
        PLATINUM_PLATE = add(new ItemBase("platinum_plate"));
        STEEL_PLATE = add(new ItemBase("steel_plate"));
        ELECTRUM_PLATE = add(new ItemBase("electrum_plate"));
        BRONZE_PLATE = add(new ItemBase("bronze_plate"));
        IRON_PLATE = add(new ItemBase("iron_plate"));
        GOLD_PLATE = add(new ItemBase("gold_plate"));
        INVAR_PLATE = add(new ItemBase("invar_plate"));
        COAL_PLATE = add(new ItemBase("coal_plate") {
            @Override
            public int getItemBurnTime(ItemStack itemStack) {
                return 2400;
            }
        });
        DIAMOND_PLATE = add(new ItemBase("diamond_plate"));
        EMERALD_PLATE = add(new ItemBase("emerald_plate"));
        LAPIS_PLATE = add(new ItemBase("lapis_plate"));
        REDSTONE_PLATE = add(new ItemBase("redstone_plate"));
    }
    private static void initWires() {
        COPPER_WIRE = add(new ItemBase("copper_wire"));
        TIN_WIRE = add(new ItemBase("tin_wire"));
        SILVER_WIRE = add(new ItemBase("silver_wire"));
        LEAD_WIRE = add(new ItemBase("lead_wire"));
        ALUMINUM_WIRE = add(new ItemBase("aluminum_wire"));
        NICKEL_WIRE = add(new ItemBase("nickel_wire"));
        PLATINUM_WIRE = add(new ItemBase("platinum_wire"));
        STEEL_WIRE = add(new ItemBase("steel_wire"));
        ELECTRUM_WIRE = add(new ItemBase("electrum_wire"));
        BRONZE_WIRE = add(new ItemBase("bronze_wire"));
        IRON_WIRE = add(new ItemBase("iron_wire"));
        GOLD_WIRE = add(new ItemBase("gold_wire"));
        INVAR_WIRE = add(new ItemBase("invar_wire"));
        COAL_WIRE = add(new ItemBase("coal_wire") {
            @Override
            public int getItemBurnTime(ItemStack itemStack) {
                return 800;
            }
        });
        DIAMOND_WIRE = add(new ItemBase("diamond_wire"));
        EMERALD_WIRE = add(new ItemBase("emerald_wire"));
        LAPIS_WIRE = add(new ItemBase("lapis_wire"));
        REDSTONE_WIRE = add(new ItemBase("redstone_wire"));
    }
    private static void initTools() {
        COPPER_SWORD = add(new SwordBase(Constants.Materials.COPPER_TOOL, "copper_sword"));
        COPPER_PICKAXE = add(new PickaxeBase(Constants.Materials.COPPER_TOOL, "copper_pickaxe"));
