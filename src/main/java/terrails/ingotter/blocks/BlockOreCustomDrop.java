...
public class BlockOreCustomDrop extends BlockOreBase {
    ...
    public BlockOreCustomDrop(String name, Item drop, int meta, int miningLevel, float lightLevel) {
        this(name, drop, miningLevel, lightLevel);
        this.meta = meta;
    }

    public BlockOreCustomDrop(String name, Item drop, int meta, int least_quantity, int most_quantity, int miningLevel, float lightLevel){
        this(name, drop, meta, miningLevel, lightLevel);
